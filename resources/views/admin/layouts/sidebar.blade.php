  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link {{ Route::currentRouteName() == 'booking.approved' ? '' : 'collapsed' }}" data-bs-target="#Bookings-nav" data-bs-toggle="collapse" href="#">
                <i class="ri ri-ticket-2-line"></i><span>Bookings</span><i
                    class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="Bookings-nav" class="nav-content collapse {{ Route::currentRouteName() == 'driver.approved' ? 'show' : '' }}" data-bs-parent="#sidebar-nav">
                <li>
                    <a class="{{ Route::currentRouteName() != 'booking.approved' ? '' : 'active' }}" href="{{ route('booking.approved') }}">
